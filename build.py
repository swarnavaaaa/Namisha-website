...
<body>
  ...
  <header>
    ...
    <nav class="desktop-nav">
      <ul>
        <li><a href="index.html" class="{act_index}">Home</a></li>
        <li><a href="about.html" class="{act_about}">About</a></li>
        <li><a href="psychotherapy.html" class="{act_psych}">Psychotherapy</a></li>
        <li><a href="areas-of-work.html" class="{act_areas}">Areas of Work</a></li>
        <li><a href="faqs.html" class="{act_faqs}">FAQs</a></li>
        <li><a href="resources.html" class="{act_res}">Resources</a></li>
        <li><a href="contact.html" class="{act_contact}">Contact</a></li>
      </ul>
    </nav>
...
for p in pages:
    with open(p["filename"], "w", encoding="utf-8") as f:
        ...
        nav_classes = {
            "act_index": "active" if p["filename"] == "index.html" else "",
            "act_about": "active" if p["filename"] == "about.html" else "",
            "act_psych": "active" if p["filename"] == "psychotherapy.html" else "",
            "act_areas": "active" if p["filename"] == "areas-of-work.html" else "",
            "act_faqs": "active" if p["filename"] == "faqs.html" else "",
            "act_res": "active" if p["filename"] == "resources.html" else "",
            "act_contact": "active" if p["filename"] == "contact.html" else "",
        }
        
        header = header_template.format(title=p["title"], **nav_classes)
        f.write(header + p["content"] + footer_template)
